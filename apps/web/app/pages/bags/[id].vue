...
import photoCognac1 from "~/assets/bag-1/photo-1.png";
import photoCognac2 from "~/assets/bag-1/photo-2.png";
import photoCognac3 from "~/assets/bag-1/photo-3.png";
import photoCognac4 from "~/assets/bag-1/photo-4.png";
import photoCognac5 from "~/assets/bag-1/photo-5.png";
import photoCognac6 from "~/assets/bag-1/photo-6.png";
import videoCognacSrc from "~/assets/bag-1/video.mp4";

// POC: media assets for bag-demo
import photoNoirSellier1 from "~/assets/noir-sellier/photo-1.png";
import photoNoirSellier2 from "~/assets/noir-sellier/photo-2.png";
import photoNoirSellier3 from "~/assets/noir-sellier/photo-3.png";
import photoNoirSellier4 from "~/assets/noir-sellier/photo-4.png";
import videoNoirSellierSrc from "~/assets/noir-sellier/video.mp4";
...
const mediaByBagId: Record<string, MediaItem[]> = {
	"bag-cognac": [
		{ src: videoCognacSrc, type: "video" },
		{ alt: "Photo 1", src: photoCognac1, type: "photo" },
		{ alt: "Photo 2", src: photoCognac2, type: "photo" },
		{ alt: "Photo 3", src: photoCognac3, type: "photo" },
		{ alt: "Photo 4", src: photoCognac4, type: "photo" },
		{ alt: "Photo 5", src: photoCognac5, type: "photo" },
		{ alt: "Photo 6", src: photoCognac6, type: "photo" },
	],
	"bag-demo": [
		{ src: videoNoirSellierSrc, type: "video" },
		{ alt: "Photo 1", src: photoNoirSellier1, type: "photo" },
		{ alt: "Photo 2", src: photoNoirSellier2, type: "photo" },
		{ alt: "Photo 3", src: photoNoirSellier3, type: "photo" },
		{ alt: "Photo 4", src: photoNoirSellier4, type: "photo" },
		// { alt: "Photo 5", src: photoNoirSellier5, type: "photo" },
		// { alt: "Photo 6", src: photoNoirSellier6, type: "photo" },
	],
};
	...
	for (let attempt = 0; attempt < maxAttempts; attempt += 1) {
		...
		if (privy?.user?.get) {
			try {
				...
				console.warn("[checkout-ui] unable to refresh Privy user", error);
			}
		}
